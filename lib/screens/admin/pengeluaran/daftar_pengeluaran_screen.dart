  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemCount: DummyDataPengeluaran.length,
        itemBuilder: (context, index) {
          final data = DummyDataPengeluaran[index];
...
class DataCard extends StatelessWidget {
  ...
  void _showActionMenu(BuildContext context, DataPengeluaranModel data) {
    ...
    showMenu<String>(
      ...
      items: <PopupMenuEntry<String>>[
        PopupMenuItem<String>(
          ...
          onTap: () {
            context.pushNamed('pengeluaran-detail', extra: data);
          },
        ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            _buildDataRow(Icons.category, 'Kategori Pengeluaran', data.kategoriPengeluaran),
