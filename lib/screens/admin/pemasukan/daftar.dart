...
class DaftarPemasukanScreen extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> _pemasukanData = const [
    {
      'no': 1,
      'nama': 'Dana Hibah',
      'jenis_pemasukan': 'Dana Bantuan Pemerintah',
              ...
              children: [
                ...
                SingleChildScrollView(
                  ...
                  child: DataTable(
                    ...
                    rows: _pemasukanData.map((data) {
                      return DataRow(
                        cells: [
                          DataCell(Text('${data['no']}')),
                          DataCell(Text(data['nama'])),
                          DataCell(Text(data['jenis_pemasukan'])),
                          DataCell(Text(data['tanggal'])),
                          DataCell(Text(data['nominal'])),
                          DataCell(
