...
class _WargaDetailScreenState extends State<WargaDetailScreen> {
  ...
  void initState() {
    ...
    _teleponController = TextEditingController(text: widget.dataWarga.nomorTelepon);
    _tempatLahirController = TextEditingController(text: widget.dataWarga.tempatLahir);
    _selectedDate = DateFormat("dd-MM-yyyy").parse(widget.dataWarga.tanggalLahir);
  }
                    ...
                    children: [
                      ...
                      CustomDropdown<String>(
                        ...
                        items: const [
                         ...
                         initialSelection: widget.dataWarga.keluarga, // Example value
                      ),
