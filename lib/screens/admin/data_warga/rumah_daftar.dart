    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // Kartu rumah full-width
          ..._rumahData.map((data) => _RumahCard(data: data)).toList(),
    ...
    final position = RelativeRect.fromRect(
      Rect.fromPoints(
        icon.localToGlobal(
          Offset.zero,
          ancestor: overlay,
        ), // pojok kiri atas ikon
        icon.localToGlobal(
          Offset(icon.size.width, icon.size.height),
          ancestor: overlay,
        ), // pojok kanan bawah ikon
      ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          // Header: Nomor Rumah dan tombol aksi
          Row(
          ...
          _buildStatusBadge(
            data['status'],
            data['status'] == 'Ditempati' ? Colors.blue : Colors.green,
          ),
        ],
      ),
    );
